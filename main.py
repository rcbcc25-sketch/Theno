...
photologo = 'https://sensitive-orange-2ndgmnoedd.edgeone.app/IMG_20250727_093946_936.jpg' #https://envs.sh/fH.jpg/IMG20250803719.jpg
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        "<b>Mʏ Nᴀᴍᴇ [𓍯✮⃝mr𝕮𝖍o𝖚𝖍𝖆𝖓✮⃝🚩⚝](tg://openmessage?user_id=8136984784)</b>\n\n"
        "<blockquote>You need to have an active subscription to use this bot.\n"
        "Please contact admin to get premium access.</blockquote>",
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access 🦅", url="tg://openmessage?user_id=8136984784")
        ]])
    )
...
async def txt_handler(bot: Client, m: Message):  
    ...
    (
        ...
        "<i>ᴇxᴛʀᴀᴄᴛᴇᴅ ʙʏ 𓍯✮⃝mr𝕮𝖍o𝖚𝖍𝖆𝖓✮⃝🚩⚝🤖</i>"
    )
)
